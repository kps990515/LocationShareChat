...
public class RoomActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(a.daehoshin.com.locationsharechat.R.layout.activity_room);

        roomid = getIntent().getStringExtra(Constants.ROOM_ID);

        Toolbar toolbar = findViewById(a.daehoshin.com.locationsharechat.R.id.toolbar);
    ...
    private void initMap(){
        mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(a.daehoshin.com.locationsharechat.R.id.roomMap);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(latLng -> {
            ...
            overridePendingTransition(a.daehoshin.com.locationsharechat.R.anim.anim_slide_in_top, a.daehoshin.com.locationsharechat.R.anim.anim_slide_out_bottom);
        });
    }
    ...
    private void initView(){
        chatList = findViewById(a.daehoshin.com.locationsharechat.R.id.chatList);
        edit_msg = findViewById(a.daehoshin.com.locationsharechat.R.id.edit_msg);

        adapter = new ChatAdapter(currentUser.getUid());
        chatList.setAdapter(adapter);
        chatList.setLayoutManager(new LinearLayoutManager(this));
        popUpLayout = findViewById(a.daehoshin.com.locationsharechat.R.id.popUpLayout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(a.daehoshin.com.locationsharechat.R.menu.chat_menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(menu){
            case a.daehoshin.com.locationsharechat.R.id.menu_getout:
                DatabaseManager.leaveRoom(currentUser, roomid);
                currentRoom.removeMarker();
                finish();
                break;
            case a.daehoshin.com.locationsharechat.R.id.menu_invite: invite(); break;
            case a.daehoshin.com.locationsharechat.R.id.menu_member:
                ...
                break;
            case a.daehoshin.com.locationsharechat.R.id.menu_setting:
