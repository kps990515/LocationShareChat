...
public class SettingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(a.daehoshin.com.locationsharechat.R.layout.activity_setting);
    ...
    private void initMap(){
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(a.daehoshin.com.locationsharechat.R.id.settingMap);
    ...
    private void initView(){
        toolbar = findViewById(a.daehoshin.com.locationsharechat.R.id.toolbar);
    ...
    private void setPopUpStage() {
        popUpStage = findViewById(a.daehoshin.com.locationsharechat.R.id.popUpStage);
        popUpStage.setVisibility(View.GONE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(a.daehoshin.com.locationsharechat.R.menu.detail_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case a.daehoshin.com.locationsharechat.R.id.action_close:
                finish();
                break;
        }
